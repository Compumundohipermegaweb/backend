    ...
    private fun closeCash(closeRequest: CloseRequest): Cash? {
        ...
        if (cash != null) {
            if(cash.status == "OPEN") {
                ...
                cashMovementRepository.save(CashMovement(0L, cashEnd.id, "EGRESO", Date(), 4L, "Mov. de Caja", 0L, 0L, closeRequest.userId, closeRequest.realBalance, "Cierre de Caja"), cashEnd.id)
