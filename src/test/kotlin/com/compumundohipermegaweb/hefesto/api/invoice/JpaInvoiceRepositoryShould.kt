...
class JpaInvoiceRepositoryShould {
    ...
    private companion object {
        ...
        val INVOICE = Invoice(0L, 0L, "", DATE, "", CLIENT, 0L, "", "", "", "", SaleDetails(SALE_ITEM_DETAIL, SALE_PAYMENT_DETAIL, null), 0.0, 0.0, 0.0)
        ...
        val SECOND_SAVED_INVOICE = Invoice(0L, 0L, "FV0000000000000", DATE, "", CLIENT, 0L, "", "", "", "", SaleDetails(SALE_ITEM_DETAIL, SALE_PAYMENT_DETAIL, null), 0.0, 0.0, 0.0)
