...
class GetOnlineSalesVsLocalSalesDataShould {
    ...
    private companion object {
        ...
        val LOCAL_SALE_FOR_REPORTS = Sale(1L, "B", DEFAULT_CLIENT, 0L, 0L, SaleDetails(ArrayList(), ArrayList()), 150.0, "VENTA LOCAL")
        val ANOTHER_LOCAL_SALE_FOR_REPORTS = Sale(2L, "B", DEFAULT_CLIENT, 0L, 0L, SaleDetails(ArrayList(), ArrayList()), 150.0, "VENTA LOCAL")
        val ONLINE_SALE_FOR_REPORTS = Sale(3L, "B", DEFAULT_CLIENT, 0L, 0L, SaleDetails(ArrayList(), ArrayList()), 250.0, "VENTA ONLINE")
        val ANOTHER_ONLINE_SALE_FOR_REPORTS = Sale(4L, "B", DEFAULT_CLIENT, 0L, 0L, SaleDetails(ArrayList(), ArrayList()), 250.0, "VENTA ONLINE")
