...
class InvoiceSaleShould {
    ...
    private companion object {
        ...
        val SAVED_SALE_TYPE_A = Sale(0L, TYPE_A_SALE_REQUEST.invoiceType, DEFAULT_CLIENT, TYPE_A_SALE_REQUEST.salesmanId, TYPE_A_SALE_REQUEST.branchId, SALE_DETAILS, 200.5)
